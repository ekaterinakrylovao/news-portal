...
Клонируйте репозиторий любым удобным для вас способом. И перейдите в него в терминале.
